...
static const uint8_t gamma[] = {0,0,1,1,1,2,2,2,3,3,3,4,4,4,5,5,5,6,6,6,7,7,8,8,8,9,9,9,10,10,11,11,11,12,12,13,13,13,14,14,15,15,16,16,17,17,17,18,18,19,19,20,20,21,21,22,22,23,23,24,24,25,25,26,26,27,27,28,28,29,29,30,30,31,32,32,33,33,34,34,35,36,36,37,37,38,39,39,40,40,41,42,42,43,44,44,45,46,46,47,48,48,49,50,50,51,52,53,53,54,55,56,56,57,58,59,59,60,61,62,63,63,64,65,66,67,68,68,69,70,71,72,73,74,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,103,104,105,106,107,108,109,111,112,113,114,115,117,118,119,120,122,123,124,125,127,128,129,131,132,133,135,136,137,139,140,142,143,145,146,147,149,150,152,153,155,156,158,160,161,163,164,166,167,169,171,172,174,176,177,179,181,183,184,186,188,190,191,193,195,197,199,201,203,205,206,208,210,212,214,216,218,220,222,224,226,229,231,233,235,237,239,241,244,246,248,250,253,255};
...
void display_Update(volatile uint8_t *data)
{
	...
	if (animateIndex < 6) {
		...
		for (int i = 0; i < (7*4); i++) {
			...
			fb[iR[j]] = gamma[transitionTable[phase]/2];
			fb[iG[j]] = 0;
			fb[iB[j]] = 0;
		}
		for (int i = 0; i < 36; i++) {
